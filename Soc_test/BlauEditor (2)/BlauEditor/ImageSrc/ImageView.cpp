...
bool _DrawImage(HDC hdc, const ByteImage& image,
...
void CImageView::OnDraw(CDC* pDC)
{
	...
	_DrawImage(pDC->m_hDC, m_image, 0, 0, m_image.GetWidth(), m_image.GetHeight(), 
		0, 0, m_image.GetWidth(), m_image.GetHeight());

	//pDC->TextOut(100, 10, "Object-Detect");
	B_PutText(&m_image, "LOADING", BlauPoint(210,80), pDC,30,20);
	B_PutText(&m_image, ". . . .", BlauPoint(150, 250), pDC, 80, 100);
}
...
{
	return Create(NULL, NULL, WS_CHILD | WS_VISIBLE | WS_MAXIMIZE, 
		CRect(0, 0, 0, 0), pWnd, AFX_IDW_PANE_FIRST, NULL);
}
