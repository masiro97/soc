...
#define IN_IMG(x, low, high) (x < low)? low : x > high ? high : x
...
public:
	...
	{
		int px = IN_IMG((int)(x + 0.5), 0, nWidth);
		int py = IN_IMG((int)(y + 0.5), 0, nHeight);
	...
	{
		int x0 = IN_IMG((int)x - 1, 0, nWidth);
		int x1 = IN_IMG((int)x, 0, nWidth);
		int x2 = IN_IMG((int)x + 1, 0, nWidth);
		int x3 = IN_IMG((int)x + 2, 0, nWidth);

		int y0 = IN_IMG((int)y - 1, 0, nHeight);
		int y1 = IN_IMG((int)y, 0, nHeight);
		int y2 = IN_IMG((int)y + 1, 0, nHeight);
		int y3 = IN_IMG((int)y + 2, 0, nHeight);
	...
	{
		int px[4], py[4];
		px[0] = IN_IMG((int)x - 1, 0, nWidth);
		px[1] = IN_IMG((int)x, 0, nWidth);
		px[2] = IN_IMG((int)x + 1, 0, nWidth);
		px[3] = IN_IMG((int)x + 2, 0, nWidth);
		py[0] = IN_IMG((int)y - 1, 0, nHeight);
		py[1] = IN_IMG((int)y, 0, nHeight);
		py[2] = IN_IMG((int)y + 1, 0, nHeight);
		py[3] = IN_IMG((int)y + 2, 0, nHeight);
