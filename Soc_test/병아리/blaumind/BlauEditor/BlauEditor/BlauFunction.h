...
void draw_tracked_position(ByteImage * frame, template_matching_based_tracker * tracker);
void draw_tracked_locations(ByteImage * frame, template_matching_based_tracker * tracker);
void draw_detected_position(ByteImage * frame, planar_pattern_detector * detector);
