...
{
	ByteImage * dx = &ByteImage(image->GetWidth(), image->GetHeight(), 1);
	ByteImage * dy = &ByteImage(image->GetWidth(), image->GetHeight(), 1);
	ByteImage * result= &ByteImage(image->GetWidth(), image->GetHeight(), 1);
