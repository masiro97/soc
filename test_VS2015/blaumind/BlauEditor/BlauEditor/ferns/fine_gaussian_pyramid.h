...
class fine_gaussian_pyramid
{
 public:
  ...
  fine_gaussian_pyramid(int type, ByteImage * image, int outer_border, int number_of_octaves, int inner_border = 0);
  ...
  void set_image( ByteImage * image);
  ...
  ByteImage  original_image;
  ByteImage * aztec_pyramid;
  ByteImage * full_images;
  ...
  void rawReduce(ByteImage * original_image, ByteImage * halfsize_image);
  void expand(ByteImage * original_image, ByteImage * dblesize_image);
  void expand(ByteImage * original_image, ByteImage * dblesize_image, int width, int height);
  void expand(ByteImage * original_image, ByteImage * final_image, int n);


	IntImage  intermediate_int_image;
  int widthStep_int;
  float * coeffs;
